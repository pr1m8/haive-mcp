...
class MCPServerAnalyzer:
    ...
    def analyze(self, obj: Any, source: Optional[str] = None) -> Optional[MCPServerConfig]:
        ...
        try:
            ...
            elif isinstance(obj, MCPServerConfig):
                return obj
            elif hasattr(obj, "to_mcp_config"):
    ...
    def _analyze_dict_config(self, config: Dict[str, Any], source: Optional[str] = None) -> Optional[MCPServerConfig]:
    ...
    def _analyze_object(self, obj: Any, source: Optional[str] = None) -> Optional[MCPServerConfig]:
    ...
    def discover_from_registry(self, registry_path: Optional[Path] = None) -> List[MCPServerConfig]:
