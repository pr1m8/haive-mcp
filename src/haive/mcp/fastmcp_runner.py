        ...
        if server_name in self.processes:
            ...
            if process.poll() is None:
                ...
                try:
                    ...
                    status["memory_usage"] = f"{ps_process.memory_info().rss / 1024 / 1024:.1f} MB"
        ...
        while self._running:
            ...
            for server_name in list(self.processes.keys()):
                ...
                if process.poll() is not None:
                    logger.warning(f"Server '{server_name}' has stopped (exit code: {process.returncode})")
            ...
            if args:
                ...
                if not servers:
                    ...
                    for server in servers:
                        print(f"{server['name']:<20} {server['pid'] or 'N/A':<10} "
