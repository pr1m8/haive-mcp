...
@mcp.tool()
async def search_files(directory: str, search_term: str, file_pattern: str = "*.py") -> Dict[str, List[str]]:
...
@mcp.prompt()
async def refactor_prompt(code: str, goal: str, language: str = "python") -> List[Dict[str, str]]:
