...
When using [`uvx`](https://docs.astral.sh/uv/guides/tools/) no specific installation is needed. We will use it to directly run _mcp_server_indexnow_ from the client app.
...
> Assistant, please use the IndexNow server to submit the URL `https://your-website.com/updated-page` with the key _'your-indexnow-key'_.

Or for multiple URLs:

> Assistant, please use the IndexNow server to submit the following URLs with the key _'your-indexnow-key'_:
>
