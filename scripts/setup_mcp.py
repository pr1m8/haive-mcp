...
def show_usage_examples():
    ...
    examples = [
        ("Discover servers", "python mcp_manager.py discover --auto-install --limit 10"),
        ("Install specific servers", "python mcp_manager.py install --servers filesystem github postgres"),
