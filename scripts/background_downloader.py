...
def download_mcp_servers():
    ...
    if data_file.exists():
        ...
        print(f"📊 Data length: {len(server_data) if isinstance(server_data, list) else 'N/A'}")
    ...
    print(f"\n✅ Download complete!")
    print(f"📊 Results: {config['download_summary']['successful']}/{config['download_summary']['total']} successful")
