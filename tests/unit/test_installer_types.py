...
class TestNPMInstaller(TestInstallerBase):
    ...
    @pytest.mark.asyncio
    async def test_install_real_package(self, npm_installer, npm_config, npm_template, test_dir):
    ...
    @pytest.mark.asyncio
    async def test_verify_installation(self, npm_installer, npm_config, npm_template, test_dir):
...
class TestPipInstaller(TestInstallerBase):
    ...
    @pytest.mark.asyncio
    async def test_install_real_package(self, pip_installer, pip_config, pip_template, test_dir):
    ...
    @pytest.mark.asyncio
    async def test_verify_installation(self, pip_installer, pip_config, pip_template, test_dir):
...
class TestGitInstaller(TestInstallerBase):
    ...
    @pytest.mark.asyncio
    async def test_clone_real_repository(self, git_installer, git_config, git_template, test_dir):
    ...
    @pytest.mark.asyncio
    async def test_verify_clone(self, git_installer, git_config, git_template, test_dir):
...
class TestDockerInstaller(TestInstallerBase):
    ...
    @pytest.mark.asyncio
    async def test_can_handle_docker_method(self, docker_installer, docker_config, docker_template):
    ...
    @pytest.mark.asyncio
    async def test_pull_real_image(self, docker_installer, docker_config, docker_template, test_dir):
        """Test pulling a real docker image."""
        test_dir.mkdir(parents=True, exist_ok=True)
        
        result = await docker_installer.install(docker_config, docker_template, test_dir)
    ...
    @pytest.mark.asyncio
    async def test_verify_image(self, docker_installer, docker_config, docker_template, test_dir):
        """Test verifying docker image."""
        test_dir.mkdir(parents=True, exist_ok=True)
        
        # Pull first
        install_result = await docker_installer.install(docker_config, docker_template, test_dir)
        if install_result["success"]:
            # Verify
            verified = await docker_installer.verify(docker_config, docker_template, test_dir)
            assert verified is True
