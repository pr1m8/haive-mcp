...
- **Basic Project Build**
  ...
  > _"Build this solution at `C:/Path/To/Project.sln` using `Release|x64`."_

- **Unreal Engine Build**
  > _"Build the solution located at `C:/Projects/MyGame/MyGame.sln` using `Development Editor|Win64`."_
