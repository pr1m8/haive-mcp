...
3.  **Configure MCP Client:**
    ...
    _Restart your MCP client (e.g., reload VS Code) after modifying the settings._
...
4.  **Create `.env` File:**
    ...
    _Replace the placeholder values with your actual Sentry details._
...
- **Example Output:** (List of issue objects, similar structure to the output of `get_issue`)
  ...
  [
    ...
    {
      "id": "987654322",
      "title": "NullPointerException in UserServic",
      "permalink": "..."
    }
    // ... more issues
  ]
