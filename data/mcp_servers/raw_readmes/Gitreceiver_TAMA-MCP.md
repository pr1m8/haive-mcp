...
_(See `.env.example` for a template)_
...
_(Valid statuses: pending, in-progress, done, deferred, blocked, review)_
...
_(Note: This might require administrator privileges depending on your shell and OS settings)_
