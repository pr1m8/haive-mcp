...
MCP server allowing any and all command execution over CMD(BE CAREFUL).
...
**Last Updated:** 2025-07-03T20:29:49.874711+00:00
...
.. code-block:: bash
   ...
   git clone https://github.com/phialsbasement/cmd-mcp-server
