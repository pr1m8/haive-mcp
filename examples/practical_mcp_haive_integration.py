...
class MCPToolDemo:
    ...
    def __init__(self):
        ...
        self.data_path = Path(__file__).parent.parent / "data" / "mcp_servers" / "ALL_MCP_SERVERS_COMPLETE.json"
...
async def demo_database_agent():
    ...
    if results:
        ...
        python_db_tools = [s for s in results if s.get('language', '').lower() == 'python']
...
async def main():
    ...
    print("\n\n✅ All demos complete!")
    print("\nNext steps:")
    print("1. Try the integrated web interface for easy tool discovery and installation")
